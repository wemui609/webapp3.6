...
<h2>Lookup</h2>
	...
	<form method="post" action="lookup.php">
		<label>Name:<br>
			<input style="border: 1px solid #000000" ; type="text" name="name17" required>
...
if(isset($_POST['name17'])) {

	$name = $_POST['name17'];
		$imagedir1 = "$name17/image.png";
		$imagedir2 = "$name17/image.jpg";
...
$imagedir = $imagedir1;
	...
	$profile = file("$name17/profile.txt");



	$name17 = trim($profile[0]);
	$email17 = trim($profile[1]);
	} else{
